...
const Results = () => {
    ...
    let groupResults = results.filter(result => result.date < new Date()).sort((a, b) => a.round - b.round).reduce(function (a, b) {
        a[b.date] = a[b.date] || [];
        a[b.date].push(b);
        return a;
    }, Object.create(null));
    ...
    return (
        <div>
            <GetResults setStartingRound={setStartingRound} setResults={setResults} rounds={rounds} />
